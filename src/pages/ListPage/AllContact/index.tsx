    ...
    <>
      <TitleContainer>
        ...
        <Button onClick={navigateToNewContact}>
          <Icons name="add" color="white" className="mr-4" /> New Contact
        </Button>
      </TitleContainer>
      ...
      {loading ? (
        ...
        <Text text="No contacts found..." color={colorToken.lightGray} />
      ) : (
        <ContactContainer>
          {contacts.map((contact) => (
            <ContactCard
              ...
              handleToggleFav={(e) => handleFavorite(e, contact.id)}
            />
          ))}
        </ContactContainer>
      )}
