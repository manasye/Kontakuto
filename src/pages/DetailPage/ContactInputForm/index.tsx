...
function InputForm({
  ...
  }, [handleCancel, navigate, param.id]);
  ...
  return (
    <Container onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="mb-8">
        <Label>
          Phone Number{" "}
          <HelperText>(e.g. 08571827182, +628571827182)</HelperText>
        </Label>
      </div>
      ...
      <ButtonContainer>
        <Button variant="secondary" onClick={_handleCancel} className="mr-8">
          Cancel
        </Button>
